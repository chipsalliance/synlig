...
def main():
    ...
    parser.add_argument("--ref-test-dir", type=Path, default=Path.cwd()/"tests"/"bsg_micro_designs"/"results",
            help="Referential test directory to compare generated verilog netlists with.")
    parser.add_argument("--output-dir", type=Path, default=Path.cwd()/"tests"/"bsg_micro_designs"/"build",
